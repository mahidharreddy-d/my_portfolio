  ...
  Widget build(BuildContext context) {
      ...
      Row(mainAxisAlignment: MainAxisAlignment.end, children: [
        ...
        Row(children: const [
          NavBarItemWithIcon(
            ...
            url: 'https://github.com/mahidharreddy-d',
          ),
          SizedBox(width: 10),
          NavBarItemWithIcon(
              text: 'facebook',
              icon: ImageAssetConstants.facebook,
              url: 'https://www.facebook.com/profile.php?id=100072364666944/'),
          SizedBox(width: 10),
          NavBarItemWithIcon(
              text: 'linkedIn',
              icon: ImageAssetConstants.linkedIn,
              url: 'https://www.linkedin.com/in/mahidhar-reddy-d-a10164217/'),
          SizedBox(width: 50),
        ])
      ])
    ]);
    List<Widget>? navBarColumn = [
      ...
      NavBarItem(
          text: 'github',
          onTap: () async {
            await launch('https://github.com/mahidharreddy-d');
          }),
      NavBarItem(
          text: 'facebook',
          onTap: () async =>
              await launch('https://www.facebook.com/profile.php?id=100072364666944/')),
      NavBarItem(
          text: 'linkedIn',
          onTap: () async => await launch(
              'https://www.linkedin.com/in/mahidhar-reddy-d-a10164217/')),
    ];
    return Stack(
      children: [
        ObxValue<RxDouble>(
